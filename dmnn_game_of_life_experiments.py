...
for i in [5]:#range(len(net)):
    print(i)
    results[i] = dmnn.train_dmnn(x,y,net[i],dmnn.IoU,xval = xval,yval = yval,sample = True,neighbors = 256,epochs = 100000,batches = 1,notebook = True,epoch_print= 100,epoch_store = 10,error_type = 'max')
